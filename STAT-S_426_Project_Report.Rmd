...
title: |
  | Project Report
  | Baysian Option Pricing Using Mixed Normal Heteroskedasticity Models
...
```{r diagnostics,fig.cap="Posterior density of mu1 and mu2",fig.height=4,fig.pos="H"}
...
```{r,echo=FALSE,fig.cap="posterior density of pi1 and pi2",fig.height=4,fig.pos="H"}
...
(1) In the years of 2006 and 2007, the negative component of mixture normal dominates the entire model because of 
