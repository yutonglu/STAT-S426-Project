...
$\sigma^{2}=(1e-04,2e-04)$  and $\pi$ = (`r p`). The mixture density seems close to the real density especially when the return is positive. Thus, we may begin our following computations based on this model.
...
that the sum of weighted expected value is equal to 0 so that the $\mu$s' need to have opposite sides. 
