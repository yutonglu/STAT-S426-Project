...
plot(density(trace[,1]), type = 'l', ylab = expression(p(mu)),las = 1,xlim = c(-0.020,0.020),
...
plot(density(trace[,3]), type = 'l', ylab = expression(p(sigma^2)), las = 1, xlim = c(5e-5,3.5e-4),
...
plot(density(trace[,5]), type = 'l', ylab = expression(p(pi)),xlim = c(0.2,0.8), las = 1,
